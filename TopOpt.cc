...
PetscErrorCode TopOpt::SetUpMESH() {
    ...
    // x - dir
//    printf("Here1: %f\n", (nxyz[0] - 1.0) / ((PetscInt)divisor));
//    printf("Here2: %f\n", std::floor((PetscScalar)(nxyz[0] - 1) / divisor));
...
PetscErrorCode TopOpt::SetUpOPT() {
    ...
    VecSet(x, 0e0);      // Initialize to volfrac !
...
PetscErrorCode TopOpt::WriteRestartFiles(PetscInt* itr) {
